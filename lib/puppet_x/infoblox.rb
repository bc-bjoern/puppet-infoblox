module PuppetX
  class Infoblox < Puppet::Provider
    ...
    def self.infoblox_client
      ::Infoblox::Connection.new(username: client_config['default']['username'], password: client_config['default']['password'], host: client_config['default']['host'], ssl_opts: client_config['default']['ssl_opts'])
    end
